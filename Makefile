...
CFLAGS		+= -fvisibility=hidden -std=c23 -Iinclude -Iexternal/assimp/include -Iinclude/cglm -IGameNetworkingSockets/include $(VARS) $(shell pkg-config --cflags sdl3 sdl3_ttf sdl3_image) -DVERSION=\"$(VERSION)\"
CXXFLAGS	 = $(CFLAGS)
